...
class MapSampleState extends State<MapSample> {
  ...
  static const CameraPosition _kCollege = CameraPosition(
      ...
      target: LatLng(21.101789, -101.646002),
      tilt: 59.440717697143555,
      zoom: 19.151926040649414);

  static const _kGoogleOriginMarker = Marker(
    markerId: MarkerId('_kGooglePlaceOrigin'),
    infoWindow: InfoWindow(title: 'Pizzeria Julietta'),
    icon: BitmapDescriptor.defaultMarker,
    position: LatLng(21.101789, -101.646002),
  );
  static final Marker _kGoogleStadiumMarker = Marker(
    markerId: const MarkerId('_kGooglePlaceTarget'),
    infoWindow: const InfoWindow(title: 'Las Guacamayas'),
    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueBlue),
    position: const LatLng(21.133199, -101.664843),
  );

  static const Polyline _kPolyline = Polyline(
      polylineId: PolylineId('_kPolyline'),
      points: [LatLng(21.101789, -101.646002), LatLng(21.133199, -101.664843)],
      width: 5);
